...
{
	return (cast(uint) version0 >> 12) & 0x3ff;
}

extern (D) auto VK_VERSION_PATCH(T)(auto ref T version0)
{
	return cast(uint) version0 & 0xfff;
}
...
alias PFN_vkDebugReportCallbackEXT = uint function (VkDebugReportFlagsEXT flags, VkDebugReportObjectTypeEXT objectType, ulong object, size_t location, int messageCode, const(char)* pLayerPrefix, const(char)* pMessage, void* pUserData);
...
alias PFN_vkDebugUtilsMessengerCallbackEXT = uint function (VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageType, const(VkDebugUtilsMessengerCallbackDataEXT)* pCallbackData, void* pUserData);
...
enum VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT = VkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT_EXT;
